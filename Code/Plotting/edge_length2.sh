...
FOLDER="/Users/stephan/Desktop/RA Network Simulations in VR/Edge Length Statistics/Comparison Two Strategies/Method1/"
FILE=$1
FORCE=false
length=10
...
#../bin/ugshell -call "test_import_swc_and_regularize(\"${FILENAME}.swc\", -1, \"min\", 0, $FORCE)" > log
../bin/ugshell -call "test_import_swc_and_regularize(\"${FILENAME}.swc\", $length, \"user\", 0, $FORCE)" 
